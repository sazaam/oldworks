function delete_friend_group(form){ return legacy_filter('delete_friend_group', form, 'communication', 'procCommunicationDeleteFriendGroup', filterAlertMessage, [], 'Vous voulez sûrement supprimer?', {}) };
(function($){
