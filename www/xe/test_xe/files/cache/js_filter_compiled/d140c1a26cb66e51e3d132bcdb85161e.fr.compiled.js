function insert_page_content(form){ return legacy_filter('insert_page_content', form, 'page', 'procPageAdminInsertContent', completeInsertPageContent, ['error','message','mid','module_srl','page'], 'Vous voulez sûrement soumettre?', {}) };
(function($){
