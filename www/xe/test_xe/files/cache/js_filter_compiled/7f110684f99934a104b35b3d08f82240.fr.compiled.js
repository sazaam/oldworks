function delete_checked_message(form){ return legacy_filter('delete_checked_message', form, 'communication', 'procCommunicationDeleteMessages', filterAlertMessage, [], 'Vous voulez sûrement supprimer?', {}) };
(function($){
