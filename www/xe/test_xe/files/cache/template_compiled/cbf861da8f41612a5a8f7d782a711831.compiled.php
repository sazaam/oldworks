<?php if(!defined("__XE__"))exit;?><section id="tmpPageSizeLayer" class="x_modal x wgs" hidden>
	...
	<form action="index.php"><input type="hidden" name="error_return_url" value="<?php echo htmlspecialchars(getRequestUriByServerEnviroment(), ENT_COMPAT | ENT_HTML401, 'UTF-8', false) ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
		<div class="x_modal-header">
			<h1><?php echo $__Context->lang->cmd_widget_size ?></h1>
		</div>
		<div class="x_modal-body">
			<table class="x_table x_table-striped x_table-hover">
				...
				<col />
				<tr>
					<th><?php echo $__Context->lang->cmd_widget_align ?></th>
					<td colspan="2">
						<select name="widget_align">
							<option value="left"><?php echo $__Context->lang->cmd_widget_align_left ?></option>
							<option value="right"><?php echo $__Context->lang->cmd_widget_align_right ?></option>
						</select>
					</td>
				</tr>
				<tr>
					<th><?php echo $__Context->lang->cmd_widget_size ?></th>
					<td colspan="2">
				...
				<tr>
					<th rowspan="3"><?php echo $__Context->lang->cmd_widget_margin ?></th>
				...
				<tr>
					<th rowspan="3"><?php echo $__Context->lang->cmd_widget_padding ?></th>
				...
				<tr>
					<th rowspan="3"><?php echo $__Context->lang->cmd_widget_border ?></th>
					<td colspan="2" style="text-align:center">
						<input type="number" name="border_top_thick" value="" class="small_input" /> px
						<select name="border_top_type">
							<option value="solid"><?php echo $__Context->lang->cmd_widget_border_solid ?></option>
							<option value="dotted"><?php echo $__Context->lang->cmd_widget_border_dotted ?></option>
						</select>
				...
				<tr>
					<th><?php echo $__Context->lang->cmd_widget_background_color ?></th>
					<td colspan="2"><input type="text" name="background_color" value="" class="input color-indicator" /></td>
				</tr>
				<tr>
					<th><?php echo $__Context->lang->cmd_widget_background_image_url ?></th>
					<td colspan="2">
						...
						<div style="margin-bottom:5px">
							<select name="background_repeat">
								<option value="repeat"><?php echo $__Context->lang->cmd_widget_background_image_repeat ?></option>
								<option value="no-repeat"><?php echo $__Context->lang->cmd_widget_background_image_no_repeat ?></option>
								<option value="repeat-x"><?php echo $__Context->lang->cmd_widget_background_image_x_repeat ?></option>
								<option value="repeat-y"><?php echo $__Context->lang->cmd_widget_background_image_y_repeat ?></option>
							</select>
						</div>
						<div style="margin-bottom:5px">
							<?php echo $__Context->lang->cmd_widget_background_image_x ?> : <input type="text" name="background_x" value="0" />
						</div>
						<div style="margin-bottom:5px">
							<?php echo $__Context->lang->cmd_widget_background_image_y ?> : <input type="text" name="background_y" value="0" />
						</div>
					</td>
				</tr>
			</table>
		...
		<div class="x_modal-footer">
			<input class="x_btn x_btn-inverse" type="submit" value="<?php echo $__Context->lang->cmd_save ?>" />
		</div>
	</form>
	<style scoped>
