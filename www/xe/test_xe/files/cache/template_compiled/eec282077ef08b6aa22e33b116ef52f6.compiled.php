	...
	<div class="x_modal-body">
		<ol>
			<li>
				...
				<?php if($__Context->lang_type == 'ko'){ ?><img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/01.png" alt="" /><?php } ?>
				<?php if($__Context->lang_type != 'ko'){ ?><img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/01_en.png" alt="" /><?php } ?>
			</li>
			<li>
				<p><?php echo $__Context->lang->faceoff_migration[3] ?></p>
				<?php if($__Context->lang_type == 'ko'){ ?><img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/02.png" alt="" /><?php } ?>
				<?php if($__Context->lang_type != 'ko'){ ?><img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/02_en.png" alt="" /><?php } ?>
			</li>
			<li>
				<p><?php echo $__Context->lang->faceoff_migration[4] ?></p>
				<img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/03.png" alt="" />
			</li>
			<li>
				<p><?php echo $__Context->lang->faceoff_migration[5] ?></p>
				<?php if($__Context->lang_type == 'ko'){ ?><img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/04.png" alt="" /><?php } ?>
				<?php if($__Context->lang_type != 'ko'){ ?><img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/04_en.png" alt="" /><?php } ?>
			</li>
			<li>
				<p><?php echo $__Context->lang->faceoff_migration[6] ?></p>
				<?php if($__Context->lang_type == 'ko'){ ?><img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/05.png" alt="" /><?php } ?>
				<?php if($__Context->lang_type != 'ko'){ ?><img src="/xe/test_xe/modules/layout/tpl/faceoff_migration/05_en.png" alt="" /><?php } ?>
			</li>
		</ol>
	</div>
