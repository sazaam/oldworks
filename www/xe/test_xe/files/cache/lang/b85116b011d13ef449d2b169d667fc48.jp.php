...
$lang->about_default_url='複数のサイトを運営する際に基本URLが必要です。XEインストール先を含むURLを入力してください。(例：http://ドメイン/インストール先)';
...
$lang->xe_license='XEのライセンスはLGPLです。';
$lang->yesterday='昨日';
$lang->today='今日';
...
$lang->msg_find_xe_path_fail='XEのインストル先が見つかりませんでした。手動で設定してください。';
...
$lang->ftp_installed_realpath='インストールされたXEの絶対パス';
...
$lang->sitelock_warning_whitelist='ここに管理者のIPを必ず記入てください。<br />もし接近が遮断された場合、\'./files/config/db.config.php\' ファイルから `\'use_sitelock\' => \'<strong>Y</strong>\'`を `\'use_sitelock\' => \'<strong>N</strong>\'`へ変更すれば遮断が解除できます。';
$lang->your_ip='接続したIP';
