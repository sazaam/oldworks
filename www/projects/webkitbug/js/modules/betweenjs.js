...
(function(__g__) {
	...
	var CSSPropertyMapper = Class('org.libspark.betweenJS::CSSPropertyMapper', {
		statics:{
			initialize:function initialize(domain, CSSPropertyMapper){
		...
		constructor:function CSSPropertyMapper(){
	...
	var UpdaterFactory = Class('org.libspark.betweenJS.core.updaters::UpdaterFactory', {
		...
		mapPool:[],
		listPool:[],
		constructor:function UpdaterFactory(){
		   return this ;
		},
	...
	var AbstractUpdater = Class('org.libspark.betweenJS.core.updaters::AbstractUpdater', {
		isResolved:false,
		target:undefined,
		constructor:function AbstractUpdater(){ 
	...
	var CompositeUpdater = Class('org.libspark.betweenJS.core.updaters::CompositeUpdater', {
		...
		d:undefined,
		updaters:undefined,
		constructor:function CompositeUpdater(target, updaters){
			this.target = target ;
	...
	var UpdaterLadder = Class('org.libspark.betweenJS.core.updaters::UpdaterLadder', {
		...
		constructor:function UpdaterLadder(parent, child, propertyName){
			this.parent = parent ;
			this.child = child ;
	...
	var PhysicalUpdaterLadder = Class('org.libspark.betweenJS.core.updaters::PhysicalUpdaterLadder', {
		...
		easing:undefined,
		duration:0.0,
		constructor:function PhysicalUpdaterLadder(parent, child, propertyName){
			this.parent = parent ;
			this.child = child ;
			this.propertyName = propertyName ;
	...
	var EnterFrameTicker = Class('org.libspark.betweenJS.tickers::EnterFrameTicker', {
		...
		time:undefined,
		constructor:function EnterFrameTicker(){
	...
	var TweenEvent = Class('org.libspark.betweenJS.events::TweenEvent', {
	   ...
	   constructor:function TweenEvent(type, data, tween){
	...
	// PHYSICAL
	var Physical = Class('org.libspark.betweenJS.core.easing::Physical', {
		statics:{
	...
	var PhysicalAccelerate = Class('org.libspark.betweenJS.core.easing::PhysicalAccelerate', {
		...
		a:undefined,
		fps:undefined,
		constructor:function PhysicalAccelerate(iv, a, fps){ 
		   this.iv = iv ;
		   this.a = a ;
		   this.fps = fps ;
	...
	var PhysicalExponential = Class('org.libspark.betweenJS.core.easing::PhysicalExponential', {
		...
		th:undefined,
		fps:undefined,
		constructor:function PhysicalExponential(f, th, fps){ 
		   this.f = f ;
		   this.th = th ;
		   this.fps = fps ;
	...
	var PhysicalUniform = Class('org.libspark.betweenJS.core.easing::PhysicalUniform', {
		v:undefined,
		fps:undefined,
		constructor:function PhysicalUniform(v, fps){ 
		   this.v = v ;
		   this.fps = fps ;
	...
	*/
	...
	var BetweenJS = Class('org.libspark.betweenJS::BetweenJS', {
		statics:{
			...
			*/
			initialize:function initialize(domain, BetweenJS){
		...
		constructor:function BetweenJS(){
		   trace('Not meant to be instanciated...') ;
		}
	}) ;
...
// CUSTOM
var CustomFunctionEasing = function CustomFunctionEasing(f){
...
var EaseNone = function(){
	return {calculate:function calculate(t, b, c, d){
		return c * t / d + b ;
	}} ;
}
...
// EXPONENTIAL & EXPO
var ExponentialEaseIn = function(){
	return {calculate:function(t, b, c, d){
