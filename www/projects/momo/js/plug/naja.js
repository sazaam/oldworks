...
/* KOMPAT */
var Kompat = NS('Kompat', NS('naja.detect::Kompat', Class.$extend({
   __classvars__ : {
      version:0.1,
      kompat:null,
      namespaces:{
...
/* XLOADER */
var XLoader = NS('XLoader', NS('naja.load::XLoader', Class.$extend(function(){
   var d = document ;
   var brows, head,
   pending = {},
   pCnt = 0,
...
/* NET */
var Request = NS('Request', NS('naja.net::Request', Class.$extend({
   __classvars__ : {
      version:'0.0.2',
      namespaces : [
...
/* COMMANDS */
var Command = NS('Command', NS('naja.command::Command', EventDispatcher.$extend({
   __classvars__ : {
      version:'0.0.2',
      toString:function(){
...
var CommandQueue = NS('CommandQueue', NS('naja.command::CommandQueue', Command.$extend({
   __classvars__ : {
      version:'0.0.2',
      toString:function(){
...
var WaitCommand = NS('WaitCommand', NS('naja.command::WaitCommand', Command.$extend({
   __classvars__ : {
      version:'0.0.1',
      toString:function(){
...
var AjaxCommand = NS('AjaxCommand', NS('naja.commands::AjaxCommand', Command.$extend({
   __classvars__ : {
      version:'0.0.2',
      toString:function(){
...
/* STEP */
var Step = NS('Step', NS('naja.step::Step', EventDispatcher.$extend({
    __classvars__:{
        version:'0.0.1',
...
var HierarchyChanger =  NS('HierarchyChanger', NS('naja.step::HierarchyChanger', Class.$extend({
    __classvars__:{
        version:'0.0.1',
...
var Hierarchy =  NS('Hierarchy', NS('naja.step::Hierarchy', Class.$extend({
    __classvars__:{
        version:'0.0.1',
...
var AddressHierarchy = NS('AddressHierarchy', NS('naja.net::AddressHierarchy', Hierarchy.$extend({
    __classvars__:{
        version:'0.0.1',
...
var AddressChanger = NS('AddressChanger', NS('naja.net::AddressChanger', HierarchyChanger.$extend({
    __classvars__:{
        version:'0.0.1',
        dependancies:[jQuery, jQuery.fn.hashchange], // Jquery, Jquery-ba-hashchange
        toString:function()
...
/* MAIN SPILL TOOLKIT */
var Toolkit = NS('Toolkit', NS('naja.toolKit::Toolkit', Class.$extend({
    __classvars__ : {
        version:'0.0.1', 
