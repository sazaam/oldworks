...
package frocessing.shape 
{
	...
	*/
	public class FShapeImageLoader extends FShapeImage implements IFShape, IObjectLoader
	{
		 ...
		 * 
		 */
		public function FShapeImageLoader( url:String, loader:Loader = null, callback:Function=null, x:Number=0, y:Number=0, width:Number=NaN, height:Number=NaN, parent_group:FShapeContainer=null ) 
		{
