package begin.eval {		import begin.eval.dump.ByteLoader;		import flash.events.Event;	import flash.events.EventDispatcher;	/**
	...
	public class Eval extends EventDispatcher {
		...
		public function eval(script : String, scriptName : String) : Eval {
			if (!initialized)
				loadEsc(script, scriptName);
			else
				loadScript(script, scriptName);
			return this;				
		}
		...
		private function escComplete(event : Event = null) : void {
			if (event != null) {
				var loader : ByteLoader = ByteLoader(event.target);
		 ...
		 * @private
		 */
		private function loadEsc(script : String, scriptName : String) : void {
			if (esc_bytes == null) {
