package of.app.required.build
{
	...
	public class XBuild extends EventDispatcher
	{
		...
		private function configure():void
		{
			...
			XUser.factory.classes.dialoger.jsModule.init(scripts) ;
			XUser.factory.classes.dialoger.initLinks(links) ;
			XUser.factory.classes.dialoger.swfAddress.debug_tf = XConsole.TF ;
			XUser.factory.classes.dialoger.swfAddress.home = defaultAddress ;
			trace(XUser.factory.classes.dialoger.swfAddress.home)
