...
package frocessing.text 
{
	...
	*/
	public class FontUtil 
	{
		 ...
		 * 文字情報を取得します
		 */
		public static function getChar( f:PFont, charcode:uint, fontSize:Number ):PChar
		{
		...
		public static function getWordImage( f:PFont, str:String, fontSize:Number, letterSpace:Number=0 ):BitmapData
		{
			var _mat:FMatrix2D = new FMatrix2D( fontSize/f.fwidth, 0, 0, fontSize/f.fheight );
			var datas:Array = [];
			var xoffsets:Array = [];
			var xo:Number = 0;
			var dat:PChar;
