...
///////////////////////////////////////////////////////////////////////////////// STATICS
		...
		{ __instance.addEventListener(type, listener, useCapture, priority, useWeakReference) ; return __instance }
		static public function removeEventListener(type:String, listener:Function, useCapture:Boolean = false):XAllLoader
		{ __instance.removeEventListener(type, listener, useCapture) ; return __instance }
		static public function hasEventListener(type:String):Boolean
		{ return __instance.hasEventListener(type) }
		static public function willTrigger (type:String):Boolean 
		{ return __instance.willTrigger(type) }
		static public function dispatchEvent (event:Event):Boolean 
		{ return __instance.dispatchEvent(event) }
...
////////////////////////////////////////////////////////////////////////////////////GETTERS & SETTERS
		...
		static public function get loader():XLoader { return __instance.loader }
		...
		public function get loader():IEventDispatcher{ return getLoader() }
