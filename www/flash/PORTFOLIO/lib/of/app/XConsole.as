package of.app 
{
	...
	public class XConsole {
		...
		static public function log(...rest:Array):XConsole { 
			if (!Boolean(__instance)) {
				trace('XConsole is not inited, subScope is the reason...')
				trace(rest)
				return null ;
			}
			return __instance.log.apply(__instance, [].concat(rest)) 
		}
