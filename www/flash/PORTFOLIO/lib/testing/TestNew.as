package testing 
{
	...
	public class TestNew extends Sprite 
	{
		...
		private function onResize(e:Event):void 
		{
			...
			var contY:int = 150 ;
			var arrX:int = 100 ;
			var arrY:int = (stage.stageHeight - left.height) >> 1 ;
		...
		private function createSmart(article:XML):Smart 
		{
			...
			var top:int = 0 ;
			var totalSize = 600 ;
			var baseUnitWidth:int = totalSize / limit ;
			var unitSize:int = baseUnitWidth * size ;
			var restSize:int = totalSize - unitSize ;
			//////////////////////////////// CHILD
			var child:Sprite = new Sprite() ;
			Draw.draw('rect', { g:child.graphics, color:0xFFFFFF, alpha:.25 }, 0, 0, unitSize, 200) ;
			child.x = marginBlock ;
			child.y = top ;
			...
			childTF.width = unitSize ;
			childTF.background = true ;
			childTF.backgroundColor = 0xFFFFFF ;
			...
			if(size !=3){
				...
				Draw.draw('rect', { g:fake.graphics, color:0xFFFFFF, alpha:.25 }, 0, 0, restSize, 200) ;
				...
				fakeTF.background = true ;
				fakeTF.backgroundColor = 0xFFFFFF ;
				fakeTF.width = restSize ;
