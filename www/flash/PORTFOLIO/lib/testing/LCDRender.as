package testing{
	...
	public class LCDRender extends Bitmap {
		...
		private var _display:BitmapData = new BitmapData(400, 400, true, 0);
		private var _cls:BitmapData = new BitmapData(400, 400, true, 0);
		...
		public function set screen(value:BitmapData):void { _screen = value }
		
		public function get display():BitmapData { return _display }
		public function set display(value:BitmapData):void { _display = value }
		
		public function get dot():Rectangle { return _dot }
		public function set dot(value:Rectangle):void { _dot = value}
		
		public function get cls():BitmapData { return _cls }
		public function set cls(value:BitmapData):void { _cls = value }
	}
