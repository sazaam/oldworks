package saz.geeks.text 
{
	...
	public class Text3D extends Sprite {
		...
		public function Text3D(__size:Number = 12, __font:Class = null, __color:uint = 0x000000,__text:String = "" , __x:Number = 10 , __y:Number = 10 , __w:Number = 150 , __h:Number = 150 , __z:Number = 1) {
			...
			initGraphics() ;
			//addEventListener(Event.ENTER_FRAME, drawOnce);
