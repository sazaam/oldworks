...
package org.libspark.aocontainer.builders
{
    ...
    /**
     * finalize要素を処理し、Finalizeオブジェクトを生成します。
     *
     * @author yossy
     */
    public class FinalizeHandler implements ElementHandler
    {
        /**
         * @inheritDoc
         */
        ...
        public function handleChildCreated(context:ParseContext, object:Object):void
        {
            if (object is Injection) {
                Finalize(context.peek()).injections.push(object);
            }
        }
