...
package org.libspark.aocontainer.builders
{
    ...
    import org.libspark.aocontainer.impls.BasicAOContainer;
    
    /**
     * objects要素を処理し、AOContainerオブジェクトを生成します。
     *
     * @author yossy
     */
    public class ObjectsHandler implements ElementHandler
    {
        /**
         * @inheritDoc
         */
        ...
        {
            context.push(new BasicAOContainer());
        }
        ...
        public function handleChildCreated(context:ParseContext, object:Object):void
        {
            if (object is Definition) {
                AOContainer(context.peek()).registerDefinition(Definition(object));
            }
        }
