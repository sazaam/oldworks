...
package org.libspark.aocontainer.deployments
{
    ...
    import org.libspark.aocontainer.deployers.PrototypeDeployer;
    
    /**
     * 常に新しいオブジェクトを配備する定義です。
     *
     * @author yossy
     */
    public class PrototypeDeployment implements Deployment
    {
        /**
         * @inheritDoc
         */
