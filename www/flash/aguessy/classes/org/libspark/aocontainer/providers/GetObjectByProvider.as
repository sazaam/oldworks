...
package org.libspark.aocontainer.providers
{
    ...
    /**
     * AOContainer#getObjectByを行うProviderです。
     *
     * @author yossy
     */
    public class GetObjectByProvider implements Provider
    {
        /**
         * 新しいGetObjectByProviderクラスのインスタンスを生成します。
         * @param container 検索先コンテナ
         * @param name 検索キーとなる名前
         * @param type 検索キーとなるクラス
         * @param from 検索基準となるオブジェクト定義
         */
        public function GetObjectByProvider(container:AOContainer = null, name:String = null, type:Class = null, from:Definition = null)
        {
        ...
        {
            return container.getObjectBy(name, type, from);
        }
    }
}