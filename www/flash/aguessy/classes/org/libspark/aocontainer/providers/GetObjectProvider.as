...
package org.libspark.aocontainer.providers
{
    ...
    /**
     * AOContainer#getObjectを行うProviderです。
     *
     * @author yossy
     */
    public class GetObjectProvider implements Provider
    {
        /**
         * 新しいGetObjectProviderクラスのインスタンスを生成します。
         * @param container 検索先コンテナ
         * @param key 検索キー
         * @param from 検索基準となるオブジェクト定義
         */
        public function GetObjectProvider(container:AOContainer = null, key:Object = null, from:Definition = null)
        {
        ...
        {
            return container.getObject(key, from);
        }
    }
}