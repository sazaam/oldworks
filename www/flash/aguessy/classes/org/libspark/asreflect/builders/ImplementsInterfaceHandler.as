...
package org.libspark.asreflect.builders
{
    ...
    /**
     * implementsInterface要素を処理し、ImplementsInterfaceオブジェクトを生成します。
     *
     * @author yossy
     */
    public class ImplementsInterfaceHandler implements ElementHandler
    {
        /**
         * @inheritDoc
         */
        ...
        {
            context.push(new ImplementsInterface(Class(getDefinitionByName(element.@type))));
        }
