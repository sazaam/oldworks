...
package frocessing.color {
	...
	public class ColorBlend {
		...
		*/
		...
		{
			return normalRGBA( (c1 & 0x00ff0000) >>> 16, (c1 & 0x0000ff00) >>> 8, c1 & 0x000000ff, (c2 & 0x00ff0000) >>> 16, (c2 & 0x0000ff00) >>> 8, c2 & 0x000000ff, (c1 & 0xff000000) >>> 24, (c2 & 0xff000000) >>> 24 );
		}
		/**
		 * RGBA値をブレンドします．
		 * @return 0xAARRGGBB
