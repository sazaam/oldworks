...
package frocessing.utils
{
	...
	public class FLoadUtil 
	{
		 ...
		 * 
		 * @param	url			url
		 * @param	loader		URLLoader or Loader
		 * @param	complete	callback on complete
		 * @param	error		callback on io error or security error
		 * @param	priority
		 */
		public static function load( url:String, loader:EventDispatcher = null, complete:Function = null, error:Function = null, priority:int = 0 ):void
		{
			request( new URLRequest(url), loader, complete, error, priority );
		}
		 ...
		 * @param	priority
		 */
		public static function request( request:URLRequest, loader:EventDispatcher = null, complete:Function = null, error:Function=null, priority:int=0 ):void
		{
			var loadobject:*;
			if ( loader == null )
			{
