...
package frocessing.core {
	...
	*/
	public class F5BitmapData3D extends F5Graphics3D{
		 ...
		 */
		public function F5BitmapData3D( width_:uint, height_:uint, transparent:Boolean = false, bgcolor:uint = 0xffcccccc )
		{
		...
		{
			super.endDraw();
			_bitmapData.draw( _shape, null, null, blendMode, screenRect, gc3d.imageSmoothing );
			_bitmapData.unlock();
		}
		...
		{
			gc3d.pixel3d( getX( x, y, z ), getY( x, y, z ), getZ( x, y, z ) );
		}
	}
