...
package frocessing.core.render3d
{
	...
	* @version 0.5
	*/
	public class QuadGradientTask extends QuadTask
	{		
		...
		public function QuadGradientTask( x0:Number, y0:Number, z0:Number, x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number, x3:Number, y3:Number, z3:Number ) 
		{
