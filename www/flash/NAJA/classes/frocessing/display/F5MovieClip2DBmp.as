...
package frocessing.display {
	...
	*/
	public dynamic class F5MovieClip2DBmp extends F5MovieClip2D
	{
		//bmp
		...
		public function F5MovieClip2DBmp( transparent:Boolean=true, bgcolor:uint=0xffcccccc, pixelSnapping:String="auto", smoothing:Boolean=false ) 
		{
		...
		{
			fg = new F5BitmapData2D( __stage_width, __stage_height, bmpTransparent, bmpBGColor );
			__draw_target = new Bitmap( F5BitmapData2D(fg).bitmapData, bmpPixelSnapping, bmpSmoothing );
		...
		{
			return F5BitmapData2D(fg).bitmapData;
		}
		
		public function get bmpfg():F5BitmapData2D
		{
			return F5BitmapData2D(fg);
		}
	}
