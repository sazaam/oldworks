...
package frocessing.math {
	...
	*/
	public class FMath{
		...
		private static var __random:MTRandom;
		 ...
		 * 外積ベクトルを取得します(3d).
		 */
		public static function cross3d( x0:Number, y0:Number, z0:Number, x1:Number, y1:Number, z1:Number ):Object
		{
