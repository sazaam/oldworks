package naja.model.data.loadings 
{
	...
	public class XLoadingsController
	{
		public function XLoadingsController() 
		{
...
///////////////////////////////////////////////////////////////////////////////// fromXMLNode
		static public function fromXMLNode(node:XML):XLoaderRequest
		{
			...
			req.url = pathURL(req.ext, req.url) ;
			return req ;
		}
		
		static protected function pathURL(ext:String, url:String):String
		{
			return url ;
		}
