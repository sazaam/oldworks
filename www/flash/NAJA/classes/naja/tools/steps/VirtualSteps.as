package naja.tools.steps 
{
	...
	import naja.tools.steps.I.IBasicStep;
	...
	public class VirtualSteps extends StepList implements IStep
	{
		...
		naja_local var __xml:XML ;
		naja_local var __userData:Object = {} ;
		naja_local var __currentStep:IStep ;
		naja_local var __playhead:int ;
		naja_local var history:Array ;
		naja_local var __index:int;
		naja_local var __depth:int;
		naja_local var __id:Object;
		naja_local var __ancestor:VirtualSteps;
		naja_local var __parent:VirtualSteps;
		naja_local var __isCancellable:Boolean;
...
public function launch(_num:Object = -1):void
		...
		{
			//if (_id == null) {
				//if (__currentStep) __currentStep.stop() ;
				//
